...
const projects = [
  ...
  },
  {
    ...
    img: poke,
    tags: ['React', 'API REST'],
    url: 'https://pokedexluismex.netlify.app',
    wip: false,
  },
  {
    ...
    img: rym,
    tags: ['React', 'API REST'],
    url: 'https://rymluisestrada.netlify.app',
    wip: false,
  },
  {
    title: 'Veterinaria',
    img: task,
    tags: ['React', 'Node.js', 'MongoDB'],
    url: 'https://veterinarialuiseer.netlify.app',
    wip: false,
  },
  {
    ...
    url: 'https://hanoitowersluisestrada.netlify.app',
    wip: false,
  },
  {
    title: 'Front Store',
    img: fStore,
    tags: ['React', 'CSS'],
    url: 'https://store-frontend-luis.netlify.app',
    wip: false,
  },
  {
    title: 'Random Quotes',
