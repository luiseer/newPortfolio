...
const AboutMe = () => {
  return (
    <section data-aos="zoom-in" className="bg-blue-color flex justify-center items-center gap-4  flex-wrap" id="about">
      <div>
      ...
      <div className="text-white">
        <div className="mt-5 uppercase text-green-color font-bold text-2xl">
          <h2 className='mb-10'>Acerca de Mí</h2>
        </div>
        ...
        <p>
          En el 2012 a 2016 estudie la licenciatura en sistemas computacionales.
        </p>
        <p>
          En el año 2020 inicie con varios cursos en Udemy como desarrollo web
          completo
        </p>
        <p>
